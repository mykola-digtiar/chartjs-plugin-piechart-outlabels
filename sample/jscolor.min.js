 ...
 */'use strict'; window.jscolor || (window.jscolor = (function() {
  var e = {register: function() {
    ...
    var r = new RegExp('(^|\\s)(' + n + ')(\\s*(\\{[^}]*\\})|\\s|$)', 'i'); for (var i = 0; i < t.length; i += 1) {
      if (t[i].type !== undefined && t[i].type.toLowerCase() == 'color' && e.isColorAttrSupported) {
        continue;
      } var s; if (!t[i].jscolor && t[i].className && (s = t[i].className.match(r))) {
        var o = t[i]; var u = null; var a = e.getDataAttr(o, 'jscolor'); a !== null ? u = a : s[4] && (u = s[4]); var f = {}; if (u) {
          try {
    ...
    var e = document.createElement('input'); if (e.setAttribute) {
      e.setAttribute('type', 'color'); if (e.type.toLowerCase() == 'color') {
        return !0;
      }
    } return !1;
    ...
    var n = 'data-' + t; var r = e.getAttribute(n); return r !== null ? r : null;
    ...
    var e = document.createElement('div'); var t = function(t) {
      for (var n = 0; n < t.length; n += 1) {
        if (t[n] in e.style) {
          return t[n];
        }
      }
    }; var n = {borderRadius: t(['borderRadius', 'MozBorderRadius', 'webkitBorderRadius']), boxShadow: t(['boxShadow', 'MozBoxShadow', 'webkitBoxShadow'])}; return function(e, t, r) {
      switch (t.toLowerCase()) {
      case 'opacity': var i = Math.round(parseFloat(r) * 100); e.style.opacity = r, e.style.filter = 'alpha(opacity=' + i + ')'; break; default: e.style[n[t]] = r;
      }
    };
    ...
    var r = 0; var i = 0; var s = t.getBoundingClientRect(); r = s.left, i = s.top; if (!n) {
      var o = e.getViewPos(); r += o[0], i += o[1];
    } return [r, i];
  }, getElementSize: function(e) {
    return [e.offsetWidth, e.offsetHeight];
  }, getAbsPointerPos: function(e) {
    e || (e = window.event); var t = 0; var n = 0; return typeof e.changedTouches !== 'undefined' && e.changedTouches.length ? (t = e.changedTouches[0].clientX, n = e.changedTouches[0].clientY) : typeof e.clientX === 'number' && (t = e.clientX, n = e.clientY), {x: t, y: n};
  }, getRelPointerPos: function(e) {
    e || (e = window.event); var t = e.target || e.srcElement; var n = t.getBoundingClientRect(); var r = 0; var i = 0; var s = 0; var o = 0; return typeof e.changedTouches !== 'undefined' && e.changedTouches.length ? (s = e.changedTouches[0].clientX, o = e.changedTouches[0].clientY) : typeof e.clientX === 'number' && (s = e.clientX, o = e.clientY), r = s - n.left, i = o - n.top, {x: r, y: i};
  }, getViewPos: function() {
    ...
    if (e.picker && e.picker.owner) {
      var t = e.picker.owner; var n; var r; t.fixed ? (n = e.getElementPos(t.targetElement, !0), r = [0, 0]) : (n = e.getElementPos(t.targetElement), r = e.getViewPos()); var i = e.getElementSize(t.targetElement); var s = e.getViewSize(); var o = e.getPickerOuterDims(t); var u; var a; var f; switch (t.position.toLowerCase()) {
      case 'left': u = 1, a = 0, f = -1; break; case 'right': u = 1, a = 0, f = 1; break; case 'top': u = 0, a = 1, f = -1; break; default: u = 0, a = 1, f = 1;
      } var l = (i[a] + o[a]) / 2; if (!t.smartPosition) {
      ...
      } var h = c[u]; var p = c[a]; var d = t.fixed ? 'fixed' : 'absolute'; var v = (c[0] + o[0] > n[0] || c[0] < n[0] + i[0]) && c[1] + o[1] < n[1] + i[1]; e._drawPosition(t, h, p, d, v);
    }
    ...
    var n = !!e.getSliderComponent(t); var r = [2 * t.insetWidth + 2 * t.padding + t.width + (n ? 2 * t.insetWidth + e.getPadToSliderPadding(t) + t.sliderSize : 0), 2 * t.insetWidth + 2 * t.padding + t.height + (t.closable ? 2 * t.insetWidth + t.padding + t.buttonHeight : 0)]; return r;
    ...
    if (e.mode.length > 2) {
      ...
      case 's': return 's'; case 'v': return 'v';
      }
    } return null;
    ...
    var s = n._jscInstance; e.preventDefault(t), e.captureTarget(n); var o = function(s, o) {
      ...
      var u = window.frameElement.getBoundingClientRect(); var a = [-u.left, -u.top]; o(window.parent.window.document, a);
    } var f = e.getAbsPointerPos(t); var l = e.getRelPointerPos(t); e._pointerOrigin = {x: f.x - l.x, y: f.y - l.y}; switch (r) {
    case 'pad': switch (e.getSliderComponent(s)) {
    case 's': s.hsv[1] === 0 && s.fromHSV(null, 100, null); break; case 'v': s.hsv[2] === 0 && s.fromHSV(null, null, 100);
    }e.setPad(s, t, 0, 0); break; case 'sld': e.setSld(s, t, 0);
    }e.dispatchFineChange(s);
  }, onDocumentPointerMove: function(t, n, r, i, s) {
    return function(t) {
      var i = n._jscInstance; switch (r) {
      case 'pad': t || (t = window.event), e.setPad(i, t, s[0], s[1]), e.dispatchFineChange(i); break; case 'sld': t || (t = window.event), e.setSld(i, t, s[1]), e.dispatchFineChange(i);
      }
    };
    ...
    var s = e.getAbsPointerPos(n); var o = r + s.x - e._pointerOrigin.x - t.padding - t.insetWidth; var u = i + s.y - e._pointerOrigin.y - t.padding - t.insetWidth; var a = o * (360 / (t.width - 1)); var f = 100 - u * (100 / (t.height - 1)); switch (e.getPadYComponent(t)) {
    case 's': t.fromHSV(a, f, null, e.leaveSld); break; case 'v': t.fromHSV(a, null, f, e.leaveSld);
    }
  }, setSld: function(t, n, r) {
    var i = e.getAbsPointerPos(n); var s = r + i.y - e._pointerOrigin.y - t.padding - t.insetWidth; var o = 100 - s * (100 / (t.height - 1)); switch (e.getSliderComponent(t)) {
    case 's': t.fromHSV(null, o, null, e.leavePad); break; case 'v': t.fromHSV(null, null, o, e.leavePad);
    }
    ...
    if (!e._vmlReady) {
      var t = document; t.namespaces[e._vmlNS] || t.namespaces.add(e._vmlNS, 'urn:schemas-microsoft-com:vml'); if (!t.styleSheets[e._vmlCSS]) {
        var n = ['shape', 'shapetype', 'group', 'background', 'path', 'formulas', 'handles', 'fill', 'stroke', 'shadow', 'textbox', 'textpath', 'imagedata', 'line', 'polyline', 'curve', 'rect', 'roundrect', 'oval', 'arc', 'image']; var r = t.createStyleSheet(); r.owningElement.id = e._vmlCSS; for (var i = 0; i < n.length; i += 1) {
    ...
    var t = {elm: null, draw: null}; if (e.isCanvasSupported) {
      var n = document.createElement('canvas'); var r = n.getContext('2d'); var i = function(e, t, i) {
        n.width = e, n.height = t, r.clearRect(0, 0, n.width, n.height); var s = r.createLinearGradient(0, 0, n.width, 0); s.addColorStop(0, '#F00'), s.addColorStop(1 / 6, '#FF0'), s.addColorStop(2 / 6, '#0F0'), s.addColorStop(0.5, '#0FF'), s.addColorStop(4 / 6, '#00F'), s.addColorStop(5 / 6, '#F0F'), s.addColorStop(1, '#F00'), r.fillStyle = s, r.fillRect(0, 0, n.width, n.height); var o = r.createLinearGradient(0, 0, 0, n.height); switch (i.toLowerCase()) {
        case 's': o.addColorStop(0, 'rgba(255,255,255,0)'), o.addColorStop(1, 'rgba(255,255,255,1)'); break; case 'v': o.addColorStop(0, 'rgba(0,0,0,0)'), o.addColorStop(1, 'rgba(0,0,0,1)');
        }r.fillStyle = o, r.fillRect(0, 0, n.width, n.height);
      }; t.elm = n, t.draw = i;
    } else {
      e.initVML(); var s = document.createElement('div'); s.style.position = 'relative', s.style.overflow = 'hidden'; var o = document.createElement(e._vmlNS + ':fill'); o.type = 'gradient', o.method = 'linear', o.angle = '90', o.colors = '16.67% #F0F, 33.33% #00F, 50% #0FF, 66.67% #0F0, 83.33% #FF0'; var u = document.createElement(e._vmlNS + ':rect'); u.style.position = 'absolute', u.style.left = '-1px', u.style.top = '-1px', u.stroked = !1, u.appendChild(o), s.appendChild(u); var a = document.createElement(e._vmlNS + ':fill'); a.type = 'gradient', a.method = 'linear', a.angle = '180', a.opacity = '0'; var f = document.createElement(e._vmlNS + ':rect'); f.style.position = 'absolute', f.style.left = '-1px', f.style.top = '-1px', f.stroked = !1, f.appendChild(a), s.appendChild(f); var i = function(e, t, n) {
        s.style.width = e + 'px', s.style.height = t + 'px', u.style.width = f.style.width = e + 1 + 'px', u.style.height = f.style.height = t + 1 + 'px', o.color = '#F00', o.color2 = '#F00'; switch (n.toLowerCase()) {
        case 's': a.color = a.color2 = '#FFF'; break; case 'v': a.color = a.color2 = '#000';
        }
      }; t.elm = s, t.draw = i;
    } return t;
  }, createSliderGradient: function() {
    var t = {elm: null, draw: null}; if (e.isCanvasSupported) {
      var n = document.createElement('canvas'); var r = n.getContext('2d'); var i = function(e, t, i, s) {
        n.width = e, n.height = t, r.clearRect(0, 0, n.width, n.height); var o = r.createLinearGradient(0, 0, 0, n.height); o.addColorStop(0, i), o.addColorStop(1, s), r.fillStyle = o, r.fillRect(0, 0, n.width, n.height);
      }; t.elm = n, t.draw = i;
    } else {
      e.initVML(); var s = document.createElement('div'); s.style.position = 'relative', s.style.overflow = 'hidden'; var o = document.createElement(e._vmlNS + ':fill'); o.type = 'gradient', o.method = 'linear', o.angle = '180'; var u = document.createElement(e._vmlNS + ':rect'); u.style.position = 'absolute', u.style.left = '-1px', u.style.top = '-1px', u.stroked = !1, u.appendChild(o), s.appendChild(u); var i = function(e, t, n, r) {
    ...
    function i(e, t, n) {
      ...
      case 's': var t = 1; break; case 'v': var t = 2;
      } var n = Math.round(d.hsv[0] / 360 * (d.width - 1)); var r = Math.round((1 - d.hsv[t] / 100) * (d.height - 1)); var i = 2 * d.pointerBorderWidth + d.pointerThickness + 2 * d.crossSize; var o = -Math.floor(i / 2); e.picker.cross.style.left = n + o + 'px', e.picker.cross.style.top = r + o + 'px'; switch (e.getSliderComponent(d)) {
      case 's': var u = s(d.hsv[0], 100, d.hsv[2]); var a = s(d.hsv[0], 0, d.hsv[2]); var f = 'rgb(' + Math.round(u[0]) + ',' + Math.round(u[1]) + ',' + Math.round(u[2]) + ')'; var l = 'rgb(' + Math.round(a[0]) + ',' + Math.round(a[1]) + ',' + Math.round(a[2]) + ')'; e.picker.sldGrad.draw(d.sliderSize, d.height, f, l); break; case 'v': var c = s(d.hsv[0], d.hsv[1], 100); var f = 'rgb(' + Math.round(c[0]) + ',' + Math.round(c[1]) + ',' + Math.round(c[2]) + ')'; var l = '#000'; e.picker.sldGrad.draw(d.sliderSize, d.height, f, l);
      }
    } function f() {
      var t = e.getSliderComponent(d); if (t) {
        switch (t) {
        case 's': var n = 1; break; case 'v': var n = 2;
        } var r = Math.round((1 - d.hsv[n] / 100) * (d.height - 1)); e.picker.sldPtrOB.style.top = r - (2 * d.pointerBorderWidth + d.pointerThickness) - Math.floor(m / 2) + 'px';
      }
    } function l() {
      ...
      var n; if (n = e.match(/^\W*([0-9A-F]{3}([0-9A-F]{3})?)\W*$/i)) {
        ...
        var r = n[1].split(','); var i = /^\s*(\d*)(\.\d+)?\s*$/; var s; var o; var u; if (r.length >= 3 && (s = r[0].match(i)) && (o = r[1].match(i)) && (u = r[2].match(i))) {
          var a = parseFloat((s[1] || '0') + (s[2] || '')); var f = parseFloat((o[1] || '0') + (o[2] || '')); var l = parseFloat((u[1] || '0') + (u[2] || '')); return this.fromRGB(a, f, l, t), !0;
        }
      } return !1;
      ...
      if (this._linkedElementsProcessed) {
        return;
      } this._linkedElementsProcessed = !0; var t = this.targetElement; do {
      ...
      var h = t; var p = document.getElementById(h); p ? this.targetElement = p : e.warn("Could not find target element with ID '" + h + "'");
    } else {
    ...
    } this.targetElement._jscLinkedInstance = this, this.valueElement = e.fetchElement(this.valueElement), this.styleElement = e.fetchElement(this.styleElement); var d = this; var v = this.container ? e.fetchElement(this.container) : document.getElementsByTagName('body')[0]; var m = 3; if (e.isElementType(this.targetElement, 'button')) {
    ...
    var n = document.getElementsByTagName('input'); var r = document.getElementsByTagName('button'); e.tryInstallOnElements(n, t), e.tryInstallOnElements(r, t);
